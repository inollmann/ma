...
class BoneJSONData:
  def __init__(self, SourceBoneLocationName, DestinationBoneName, BoneModificationType, ApplyToX, ApplyToY, DirectionQuatToApplyXandY):
...
class BoneToMap:
  def __init__(self, Armature, SourceBoneLocationName, DestinationBoneName, BoneModificationType, BoneDataName, ApplyToX, ApplyToY, ApplyToZ):
    #This is the source from JSON like head_bone that designates where this bone is getting it's information from in the JSON file
    self.SourceBoneLocationName = SourceBoneLocationName  
    #This is the destination bone name on the rig to apply the modifications to.
    self.BoneName = DestinationBoneName
    self.Bone = Armature.pose.bones[DestinationBoneName]
